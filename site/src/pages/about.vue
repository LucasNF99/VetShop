<template>
  <div class="o-about">
    <h4 class="o-about_title">Sobre nós</h4>
    <p class="o-about_text">
      Este sistema foi feito como o trabalho de graduação de dois alunos
     do curso de Análise e Desenvolvimento(ADS) da FATEC - Franca,
     Clayton Lopes e Lucas Ferreira.<br/> Buscando auxiliar clínicas
     veterinárias de pequeno porte com um sistema simples e leve
